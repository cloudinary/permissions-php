...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.cloudinary.com/v2/accounts/ACCOUNT_ID/permissions';
     ...
     * @var string
     */
    protected $userAgent = 'CloudinaryPermissionsPHP/1.0.0 (PHP ' . PHP_VERSION . ')';
    ...
    {
        $report  = 'PHP SDK (Cloudinary\Permissions) Debug Report:' . PHP_EOL;
