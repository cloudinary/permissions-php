...
class ErrorResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPITypes = [
        'error' => '\Cloudinary\Permissions\Model\Error'
    ];
    ...
    */
     ...
     * Gets error
     *
     * @return \Cloudinary\Permissions\Model\Error|null
     */
    public function getError(): ?\Cloudinary\Permissions\Model\Error
    {
     ...
     * Sets error
     *
     * @param \Cloudinary\Permissions\Model\Error|null $error error
     *
     * @return $this
     */
    public function setError(?\Cloudinary\Permissions\Model\Error $error): static
    {
        if (is_null($error)) {
