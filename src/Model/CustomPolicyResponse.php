...
class CustomPolicyResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomPolicyResponse';
    ...
    */
     ...
     */
    public function getData(): ?\Cloudinary\Permissions\Model\CustomPolicyResponseData
    {
     ...
     * Sets data
     *
     * @param \Cloudinary\Permissions\Model\CustomPolicyResponseData|null $data data
     *
     * @return $this
     */
    public function setData(?\Cloudinary\Permissions\Model\CustomPolicyResponseData $data): static
    {
        if (is_null($data)) {
