...
/**
 * CustomPoliciesResponse Class Doc Comment
 *
 * @package  Cloudinary\Permissions
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomPoliciesResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomPoliciesResponse';
    ...
    protected static array $openAPITypes = [
        'data' => '\Cloudinary\Permissions\Model\CustomPolicyResponseData[]',
        'nextCursor' => 'string'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Cloudinary\Permissions\Model\CustomPolicyResponseData[]|null
     */
     ...
     * Sets data
     *
     * @param \Cloudinary\Permissions\Model\CustomPolicyResponseData[]|null $data An array of custom policies.
     *
     * @return $this
     */
     ...
     * Sets nextCursor
     *
     * @param string|null $nextCursor When a request has more results to return, the next_cursor value is returned as part of the response. You can then specify this value as the cursor parameter of a following request.
     *
     * @return $this
     */
    public function setNextCursor(?string $nextCursor): static
    {
