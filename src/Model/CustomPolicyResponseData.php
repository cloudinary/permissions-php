...
/**
 * CustomPolicyResponseData Class Doc Comment
 *
 * @package  Cloudinary\Permissions
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class CustomPolicyResponseData implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomPolicyResponseData';
    ...
    */
     ...
     *
     * @param string $policyStatement A Cedar policy that permits or forbids a certain action on a certain element to a principal (API key).
     *
     * @return $this
     */
     ...
     * Sets scopeId
     *
     * @param string|null $scopeId Returned if the scope type is product environment. Can be \"all\" to represent all product environments or an ID of a specific product environment.
     *
     * @return $this
     */
     ...
     * Sets enabled
     *
     * @param bool $enabled Whether the policy is enabled or not
     *
     * @return $this
     */
     ...
     * Sets createdAt
     *
     * @param int $createdAt Creation time of the policy in epoch time
     *
     * @return $this
     */
     ...
     * Sets updatedAt
     *
     * @param int $updatedAt Last update time of the policy in epoch time
     *
     * @return $this
     */
